...
public class Grave {
    ...
    public void printGrave(String name) {
        ...
        String sourceFilePath = "src/main/Resources/Gravestone.txt"; //specify path to gravestone.txt
        String modifiedFilePath = "src/main/Resources/ModifiedGravestone.txt"; // specify modified copy path
